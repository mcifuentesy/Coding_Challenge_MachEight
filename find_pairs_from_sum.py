...
if __name__ == '__main__':
    numbers_to_evaluate = str(input('Enter only integer numbers separated by space (no repeated) to find pairs of numbers that result in a definied sum: ')) # 1 9 5 0 20 -4 12 16 7
    target_sum = int(input('Enter the target sum (only an integer): '))# 12
